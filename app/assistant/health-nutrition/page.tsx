...
export default function HealthNutritionAssistantPage() {
    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            ...
            role: 'assistant',
            content:
                'สวัสดี! ฉันคือ Health & Nutrition Assistant พร้อมให้คำแนะนำเรื่องสุขภาพ โภชนาการ และการรับประทานอาหารเพื่อสุขภาพที่ดี ส่งคำถามหรือรูปภาพอาหารเพื่อรับคำแนะนำได้เลย'
        }
    ]);
        ...
        try {
            ...
            const resp = await fetch('/api/assistant', {
                ...
                body: JSON.stringify({
                    ...
                    imageBase64,
                    assistantType: 'health-nutrition'
                })
            });
    ...
    return (
        <section className="max-w-7xl mx-auto w-full p-4 lg:p-8 pb-0 flex flex-col h-[calc(100dvh-68px)]">
            <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-lg lg:text-2xl font-medium">Health & Nutrition Assistant</h1>
            </div>
            <div
