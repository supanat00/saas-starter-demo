    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            ...
            role: 'assistant',
            content:
                'สวัสดี! ฉันคือ Study Assistant พร้อมช่วยคุณเรื่องการเรียน การบ้าน การอ่านหนังสือ และเทคนิคการจำ ส่งคำถามหรือรูปภาพเอกสารเพื่อรับความช่วยเหลือได้เลย'
        }
    ]);
    ...
    return (
        <section className="max-w-7xl mx-auto w-full p-4 lg:p-8 pb-0 flex flex-col h-[calc(100dvh-68px)]">
            <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-lg lg:text-2xl font-medium">Study Assistant</h1>
            </div>
            <div
