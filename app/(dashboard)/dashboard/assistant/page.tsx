...
export default function AssistantChatPage() {
    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            ...
            role: 'assistant',
            content:
                'สวัสดี! ฉันคือที่ปรึกษา AI ของคุณ พิมพ์คำถามหรือปัญหาที่ต้องการคำปรึกษาได้เลย'
        }
    ]);
    ...
    const handleSend = async () => {
        ...
        // Store image preview before clearing
    ...
    return (
        <section className="flex-1 p-4 lg:p-8 pb-0 flex flex-col h-full">
            ...
            >
                {messages.map((msg) => (
                    ...
                    >
                        <div
                            className={`max-w-[80%] rounded-2xl px-4 py-2 text-sm leading-6 space-y-2 ${msg.role === 'user'
            ...
            <div className="fixed bottom-0 left-0 lg:left-64 right-0 bg-gray-50 border-t border-gray-200 z-20">
